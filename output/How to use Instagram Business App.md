...
![mceclip0.png](https://support.optisigns.com/hc/article_attachments/360079336093)Click "Continue with Facebook" and sign in with your credentials.\
Yes, it is Facebook's requirement that you link your Instagram Business account to your Facebook account to use it with 3rd party app like OptiSigns.![mceclip1.png](https://support.optisigns.com/hc/article_attachments/360079336133)
...
\
**Note:**For hashtags, the app **mix** of **top posts** (popular posts all time, sorted by created time) **and recent post** (all post within the last 24 hours), however, the app cannot get the post older than 24-48h if the post is not popular (on Instagram's list of top posts).
