...
You may want to look at:Raspberry Pi: fully support Linux, you can run the distribution of your choosing that fit your organization security requirements.Or ChromeOS devices, ChromeOS is known for its enterprise support, from hardened hardware to Google Cloud Enterprise Device Management that allow you to remote manage devices, apply patches and more.Feel free to reach out to us at [support@optisigns.com](mailto:support@optisigns.com) for a free consultation call regard this topic.